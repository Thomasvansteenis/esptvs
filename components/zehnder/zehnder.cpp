...
void ZehnderRF::setup() {
  ...
  // Hardcoded pairing config — skip discovery
  this->config_.fan_networkId       = 0x342E71EF;
  this->config_.fan_main_unit_type  = 0x01;
  this->config_.fan_main_unit_id    = 0x75;
  this->config_.fan_my_device_type  = 0x03;
  this->config_.fan_my_device_id    = 0x23;
